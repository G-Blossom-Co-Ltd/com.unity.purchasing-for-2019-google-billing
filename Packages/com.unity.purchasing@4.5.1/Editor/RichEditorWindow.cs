...
namespace UnityEditor.Purchasing
{
    internal class RichEditorWindow : EditorWindow
    {
        ...
        {
            if (m_LightLinkIcon == null) m_LightLinkIcon = AssetDatabase.LoadAssetAtPath<Texture>(kLightLinkIconPath);
            if (m_DarkLinkIcon == null) m_DarkLinkIcon = AssetDatabase.LoadAssetAtPath<Texture>(kDarkLinkIconPath);

            if (m_LinkStyle == null) m_LinkStyle = new GUIStyle();
